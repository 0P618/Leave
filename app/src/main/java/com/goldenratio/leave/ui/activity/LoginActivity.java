...
//                    }
    ...
    private List<ArrayList<String>> decodeUserInfo(String json) {
        ...
        try {
            ArrayList<String> strings1 = new ArrayList<>();
            JSONObject jsonObject = new JSONObject(json);
            strings1.add(jsonObject.getString("id"));
            strings1.add(jsonObject.getString("nickname"));
            strings1.add(jsonObject.getString("name"));
            strings1.add(jsonObject.getString("sex"));
            strings1.add(jsonObject.getString("avatar"));
            strings1.add(jsonObject.getString("class"));
            strings1.add(jsonObject.getString("autograph"));
            strings1.add(jsonObject.getString("birthday"));
            strings1.add(jsonObject.getString("hometown"));
            strings1.add(jsonObject.getString("tel"));
            strings1.add(jsonObject.getString("mail"));
            strings1.add(jsonObject.getString("qq"));
            strings1.add(jsonObject.getString("wechat"));
            strings1.add(jsonObject.getString("high_school"));
            strings1.add(jsonObject.getString("token"));
            strings1.add(jsonObject.getString("department"));
            arrayLists.add(strings1);
        } catch (JSONException e) {
            Log.d("TAGTAGTAGTAG", "decodeUserInfo: " + e.getMessage());
            e.printStackTrace();
        }
        return arrayLists;
    }
